...
# ============================================================================
# Deploy 20.11.2修正: モジュールレベル自動登録は二重登録を引き起こすため削除
# 各エントリーポイント（run_dash_server.py, run_dash_server_production.py）で
# 明示的に register_interactive_callbacks(app) を呼び出す必要がある
